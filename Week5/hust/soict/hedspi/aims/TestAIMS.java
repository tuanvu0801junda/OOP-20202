...
import static hust.soict.hedspi.aims.order.Order.MAX_LIMITED_ORDERED;
import static hust.soict.hedspi.aims.order.Order.getNbOrder;

public class TestAIMS {
    public static void main(String[] args) {

        Order odr = new Order();
        System.out.println("Order now: "+getNbOrder());
        ...
        if(getNbOrder() >= MAX_LIMITED_ORDERED){
            ...
            odr3.addDigitalVideoDisc(dvd1);
            DigitalVideoDisc luck = odr3.getALuckyDVDItem();
            odr3.printOrder(luck);
